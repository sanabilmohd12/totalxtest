...
abstract class IUserfacade {
  Future<Either<MainFailure,UserModel>>uploadUser({required UserModel userModel}){
    throw UnimplementedError('uploadUser not impl');
  }
  Future<Either<MainFailure,List<UserModel>>>fetchUser({int? filterOlder, String? search}){
    throw UnimplementedError('uploadUser not impl');
  }
  void clearData();
}